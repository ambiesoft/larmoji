========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : larmoji
========================================================================


AppWizard が生成した larmoji には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには larmoji を構成している各ファイルの概要説明が含まれています。
...
larmoji.h
    ...
    みます） をインクルードし、また CLarmojiApp アプリケーションクラスを宣
    言します。

larmoji.cpp
    このファイルは CLarmojiApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\larmoji.ico
    ...
    ルです。このアイコンはリソース ファイル larmoji.rc によってインクルード
    されます。
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、larmoji.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) larmoji.pch 
